...
## 5. Risk Firewalls & Invariant Perimeter

The strategy operates under four non-negotiable deterministic firewalls:
...
graph TD
    ...
    E -- "Yes" --> F["Post-Only Maker Order"]
    E -- "No" --> G["Hold & Collect Hourly Funding Carry"]
```
